...
* Fix: Resolve blank feed label and content language during scheduled Google Merchant API sync
...
* Feature: Add support for link_template, mobile_link_template, pickup_link_template, pickup_method, and pickup_sla attributes in Google feeds.
* Feature: Add support for Google Merchant grouped attributes (variant_option, question_and_answer, and related_product) across XML, CSV, TSV, and TXT feeds.
* Feature: Add support for item_group_title and document_link attributes in Google Shopping feeds.
* Enhancement: Normalize and validate nested sub-attributes for structured repeated groups in Google feed output.
* Fix: Sanitize Google Merchant API product sync payload to prevent boolean/invalid image link errors.
...
* Fix: Prevent serialized meta corruption and map taxonomy term IDs to slugs during feed export and
import.
...
= 7.6.2 (2026-07-14) =
* Fix: Resolve reflected cross-site scripting (XSS) vulnerability in Facebook Pixel search tracking

= 7.6.1 (2026-07-10) =
* Fix: Harden custom filter query building to prevent SQL injection through untrusted filter columns
...
* Bug Fix: Prevented unnecessary feed regeneration when no product changes occur

= 7.4.82 (2026-04-24) =
* Improvement: Add nudge message to help users create a feed
* Improvement: Update plugin deactivation reasons

= 7.4.81 (2026-04-23) =
* New: Add guided tour onboarding for new users
* New: Added consent toggle option in settings
* New: Added demo feed creation based on country selection

= 7.4.80 (2026-04-21) =
* Improvement: Update onboarding of PFM

= 7.4.79 (2026-04-17) =
* Improvement: Daily aggregation and schedule telemetry flush to improve tracking efficiency
...
Keep Product Feed Manager For WooCommerce updated to the latest version. It makes sure that you get the improvements, new features, and bug fixes instantly.
