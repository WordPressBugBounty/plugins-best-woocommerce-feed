            ...
            <div class="rex-premium-feature__message">
                ...
                <div class="rex-premium-feature__btn-area">
                    ...
                    <div class="rex-premium-feature__discount-price">
                        <p class="rex-premium-feature__discount-price-label" data-discount="<?php echo esc_attr($discount_percentage); ?>"><?php printf(esc_html__('Starting at %s/year', 'rex-product-feed'), '<span style= "font-weight:600; color:#0F2F72;">' . esc_html($discount_price) . '</span>'); ?></p>
