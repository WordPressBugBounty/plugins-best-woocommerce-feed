<?php
/**
 * The YouTube Shopping Feed Template class.
 *
...
/**
 * Defines the attributes and template for YouTube Shopping feed.
 *
 * YouTube Shopping uses the Google product feed XML specification.
 *
 * @package    Rex_Product_Feed
 * @subpackage Rex_Product_Feed/admin/feed-templates/Rex_Feed_Template_Youtube_Shopping
 * @author     RexTheme <info@rextheme.com>
 */
class Rex_Feed_Template_Youtube_shopping extends Rex_Feed_Abstract_Template {
	...
	protected function init_atts() {
		$this->attributes = array(
			'Basic Information'          => array(
				...
				'mobile_link'             => 'Mobile URL [mobile_link]',
	...
	/**
	 * Define merchant's default attribute mappings.
	 *
	 * @return void
	 */
