...
/**
 * Defines the attributes and template for Google CSS Center feed.
 *
 * @package    Rex_Product_Feed
 * @subpackage Rex_Product_Feed/admin/feed-templates/Rex_Feed_Template_Google_CSS_Center
 * @author     RexTheme <info@rextheme.com>
 * @since     7.4.30
 */
class Rex_Feed_Template_Google_css_center extends Rex_Feed_Abstract_Template {
	...
	protected function init_atts() {
		$this->attributes = array(
			...
			'Detailed Product Attributes'         => array(
				...
				'product_highlights' => 'Product Highlights [product_highlights]',
