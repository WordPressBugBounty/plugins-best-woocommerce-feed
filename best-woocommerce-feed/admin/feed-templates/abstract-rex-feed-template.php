    ...
    protected function init_sanitization_options() {
        $this->sanitization_options = [
            '' => [
	            ...
	            'remove_slash'                 => __( 'Remove Slash (/)', 'rex-product-feed' ),
	            'remove_comma'                 => __( 'Remove Comma (,)', 'rex-product-feed' ),
	            'remove_exclamation'           => __( 'Remove Exclamation Mark (!)', 'rex-product-feed' ),
	            'remove_asterisk'              => __( 'Remove Asterisk (*)', 'rex-product-feed' ),
	            'remove_ampersand'             => __( 'Remove Ampersand (&)', 'rex-product-feed' ),
	            'remove_percentage'            => __( 'Remove Percentage Sign (%)', 'rex-product-feed' ),
	            'remove_parentheses'           => __( 'Remove Parentheses ()', 'rex-product-feed' ),
	            'remove_quotation_marks'       => __( 'Remove Quotation Marks (\' and ")', 'rex-product-feed' ),
	            'remove_colon'                 => __( 'Remove Colon (:)', 'rex-product-feed' ),
	            'remove_semicolon'             => __( 'Remove Semicolon (;)', 'rex-product-feed' ),
	            'remove_plus'                  => __( 'Remove Plus Sign (+)', 'rex-product-feed' ),
	            'remove_punctuation'           => __( 'Remove Punctuation', 'rex-product-feed' ),
