<?php
/**
 * The OpenAI Feed Template class.
 *
...
/**
 * Defines the attributes and template for openai feed.
 *
 * @package    Rex_Product_Feed
 * @subpackage Rex_Product_Feed/admin/feed-templates/Rex_Feed_Template_OpenAI
 * @author     RexTheme <info@rextheme.com>
 */
class Rex_Feed_Template_Openai extends Rex_Feed_Abstract_Template {
	...
	protected function init_atts() {
		$this->attributes = array(
			...
			'OpenAI Settings'                     => array(
				'enable_search'   => 'Enable Search [enable_search]',
				'enable_checkout' => 'Enable Checkout [enable_checkout]',
			),
		);
