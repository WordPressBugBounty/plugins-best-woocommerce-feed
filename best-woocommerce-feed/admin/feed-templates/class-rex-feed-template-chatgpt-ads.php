<?php
/**
 * The ChatGPT Ads Feed Template class.
 *
...
/**
 * Defines the attributes and template for ChatGPT Ads feed.
 *
 * Based on OpenAI Product Feeds Specification:
 * https://developers.openai.com/ads/product-feeds
 *
 * @package    Rex_Product_Feed
 * @subpackage Rex_Product_Feed/admin/feed-templates/Rex_Feed_Template_Chatgpt_ads
 * @author     RexTheme <info@rextheme.com>
 */
class Rex_Feed_Template_Chatgpt_ads extends Rex_Feed_Abstract_Template {
	...
	protected function init_atts() {
		$this->attributes = array(
			'Basic Information'                   => array(
				...
				'mobile_link'              => 'Mobile Product URL [mobile_link]',
			...
			'Availability & Price'                => array(
				...
				'inventory_quantity'        => 'Inventory Quantity [inventory_quantity]',
			...
			'ChatGPT Ads Settings'                => array(
				'is_ads_eligible'  => 'Is Ads Eligible [is_ads_eligible]',
				...
				'ads_metadata'     => 'Ads Metadata [ads_metadata]',
				'popularity_score' => 'Popularity Score [popularity_score]',
				'return_rate'      => 'Return Rate [return_rate]',
			),
