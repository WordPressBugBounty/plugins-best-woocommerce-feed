...
namespace RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\FileInput;
...
class FetchSettings extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\FileInput\FetchSettings\Frequency::class);
        $this->frequency = $var;
