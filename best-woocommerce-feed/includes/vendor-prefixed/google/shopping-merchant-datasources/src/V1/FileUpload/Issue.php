...
namespace RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\FileUpload;
...
class Issue extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\FileUpload\Issue\Severity::class);
        $this->severity = $var;
