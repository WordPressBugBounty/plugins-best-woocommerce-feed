...
class SupplementalProductDataSource extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
     ...
     *           combination. If unset, the data source will accept produts without that
     *           restriction.
     *     @type \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\DataSourceReference[] $referencing_primary_data_sources
     *           Output only. The (unordered and deduplicated) list of all primary data
     *           sources linked to this data source in either default or custom rules.
     *           Supplemental data source cannot be deleted before all links are removed.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.datasources.v1.DataSourceReference referencing_primary_data_sources = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\DataSourceReference>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.datasources.v1.DataSourceReference referencing_primary_data_sources = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\DataSourceReference[] $var
     * @return $this
     */
    public function setReferencingPrimaryDataSources($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\DataSourceReference::class);
