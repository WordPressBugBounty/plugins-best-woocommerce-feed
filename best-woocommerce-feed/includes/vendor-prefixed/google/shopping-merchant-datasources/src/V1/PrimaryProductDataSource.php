...
class PrimaryProductDataSource extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
     ...
     *           [CLDR territory
     *           code](https://github.com/unicode-org/cldr/blob/latest/common/main/en.xml).
     *     @type \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\PrimaryProductDataSource\DefaultRule $default_rule
     *           Optional. Default rule management of the data source. If set, the linked
     *           data sources will be replaced.
     *     @type \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\PrimaryProductDataSource\Destination[] $destinations
     *           Optional. A list of destinations describing where products of the data
     *           source can be shown.
     *           When retrieving the data source, the list contains all the destinations
     *           that can be used for the data source, including the ones that are disabled
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.datasources.v1.PrimaryProductDataSource.DefaultRule default_rule = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\PrimaryProductDataSource\DefaultRule|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.datasources.v1.PrimaryProductDataSource.DefaultRule default_rule = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\PrimaryProductDataSource\DefaultRule $var
     * @return $this
     */
    public function setDefaultRule($var)
    {
        GPBUtil::checkMessage($var, \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\PrimaryProductDataSource\DefaultRule::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.datasources.v1.PrimaryProductDataSource.Destination destinations = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\PrimaryProductDataSource\Destination>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.datasources.v1.PrimaryProductDataSource.Destination destinations = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\PrimaryProductDataSource\Destination[] $var
     * @return $this
     */
    public function setDestinations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1\PrimaryProductDataSource\Destination::class);
