...
namespace RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1beta\FileInput;
 ...
 */
class FetchSettings extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           Optional. The day of the month when the data source file should be
     *           fetched (1-31). This field can only be set for monthly frequency.
     *     @type \RexFeed\Vendor\Google\Type\TimeOfDay $time_of_day
     *           Optional. The hour of the day when the data source file should be
     *           fetched. Minutes and seconds are not supported and will be ignored.
     ...
     *
     * Generated from protobuf field <code>.google.type.TimeOfDay time_of_day = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \RexFeed\Vendor\Google\Type\TimeOfDay|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.type.TimeOfDay time_of_day = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \RexFeed\Vendor\Google\Type\TimeOfDay $var
     * @return $this
     */
    public function setTimeOfDay($var)
    {
        GPBUtil::checkMessage($var, \RexFeed\Vendor\Google\Type\TimeOfDay::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Type\DayOfWeek::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1beta\FileInput\FetchSettings\Frequency::class);
        $this->frequency = $var;
