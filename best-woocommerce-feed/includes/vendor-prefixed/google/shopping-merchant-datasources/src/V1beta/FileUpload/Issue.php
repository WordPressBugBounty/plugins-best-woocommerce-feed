...
namespace RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1beta\FileUpload;
 ...
 */
class Issue extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1beta\FileUpload\Issue\Severity::class);
        $this->severity = $var;
