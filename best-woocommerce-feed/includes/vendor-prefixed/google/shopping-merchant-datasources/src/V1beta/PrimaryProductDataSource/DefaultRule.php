...
namespace RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1beta\PrimaryProductDataSource;
 ...
 */
class DefaultRule extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     *     @type \RexFeed\Vendor\Google\Shopping\Merchant\DataSources\V1beta\DataSourceReference[] $take_from_data_sources
     *           Required. The list of data sources linked in the [default
     *           rule](https://support.google.com/merchants/answer/7450276).
     *           This list is ordered by the default rule priority of joining the data.
     *           It might include none or multiple references to `self` and supplemental
