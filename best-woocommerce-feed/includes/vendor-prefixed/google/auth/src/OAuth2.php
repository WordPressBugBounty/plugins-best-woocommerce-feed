...
class OAuth2 implements FetchAuthTokenInterface
{
     ...
     * @throws \RexFeed\Vendor\Firebase\JWT\SignatureInvalidException If the signature is invalid.
     * @throws \RexFeed\Vendor\Firebase\JWT\BeforeValidException If the token is not yet valid.
     * @throws \RexFeed\Vendor\Firebase\JWT\ExpiredException If the token has expired.
     * @return null|object
     */
