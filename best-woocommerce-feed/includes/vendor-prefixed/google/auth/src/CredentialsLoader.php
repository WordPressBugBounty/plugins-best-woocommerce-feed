...
use RexFeed\Vendor\Google\Auth\Credentials\ExternalAccountAuthorizedUserCredentials;
use RexFeed\Vendor\Google\Auth\Credentials\ExternalAccountCredentials;
use RexFeed\Vendor\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use RexFeed\Vendor\Google\Auth\Credentials\InsecureCredentials;
    ...
    UpdateMetadataInterface
{
     ...
     * @return \RexFeed\Vendor\GuzzleHttp\Client
     */
    public static function makeHttpClient(
        ...
        $stack = \RexFeed\Vendor\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);

        return new \RexFeed\Vendor\GuzzleHttp\Client([
            'handler' => $stack,
            'auth' => 'google_auth',
        ] + $httpClientOptions);
    }
