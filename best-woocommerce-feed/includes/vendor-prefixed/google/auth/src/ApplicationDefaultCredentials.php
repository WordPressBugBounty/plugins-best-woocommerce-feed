...
namespace RexFeed\Vendor\Google\Auth;

use DomainException;
use RexFeed\Vendor\Google\Auth\Credentials\AppIdentityCredentials;
use RexFeed\Vendor\Google\Auth\Credentials\GCECredentials;
use RexFeed\Vendor\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use RexFeed\Vendor\Google\Auth\Credentials\ServiceAccountCredentials;
use RexFeed\Vendor\Google\Auth\Credentials\UserRefreshCredentials;
use RexFeed\Vendor\Google\Auth\HttpHandler\HttpClientCache;
use RexFeed\Vendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use RexFeed\Vendor\Google\Auth\Logging\StdOutLogger;
use RexFeed\Vendor\Google\Auth\Middleware\AuthTokenMiddleware;
use RexFeed\Vendor\Google\Auth\Middleware\ProxyAuthTokenMiddleware;
use RexFeed\Vendor\Google\Auth\Subscriber\AuthTokenSubscriber;
use RexFeed\Vendor\GuzzleHttp\Client;
use InvalidArgumentException;
use RexFeed\Vendor\Psr\Cache\CacheItemPoolInterface;
 ...
 *
 * This allows it to be used as follows with RexFeed\Vendor\GuzzleHttp\Client:
 *
 * ```
 * use RexFeed\Vendor\Google\Auth\ApplicationDefaultCredentials;
 * use RexFeed\Vendor\GuzzleHttp\Client;
 * use RexFeed\Vendor\GuzzleHttp\HandlerStack;
 *
