...
use COM;
use com_exception;
use RexFeed\Vendor\Google\Auth\CredentialsLoader;
...
use RexFeed\Vendor\Google\Auth\Iam;
use RexFeed\Vendor\Google\Auth\IamSignerTrait;
use RexFeed\Vendor\Google\Auth\ProjectIdProviderInterface;
use RexFeed\Vendor\Google\Auth\SignBlobInterface;
use RexFeed\Vendor\GuzzleHttp\Exception\ClientException;
use RexFeed\Vendor\GuzzleHttp\Exception\RequestException;
use RexFeed\Vendor\GuzzleHttp\Exception\ServerException;
use RexFeed\Vendor\GuzzleHttp\Psr7\Request;
use InvalidArgumentException;
use RexFeed\Vendor\Psr\Http\Client\NetworkExceptionInterface;
