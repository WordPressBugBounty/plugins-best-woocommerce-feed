...
namespace RexFeed\Vendor\Google\Auth\Credentials;

use RexFeed\Vendor\Google\Auth\CredentialSource\AwsNativeSource;
use RexFeed\Vendor\Google\Auth\CredentialSource\ExecutableSource;
use RexFeed\Vendor\Google\Auth\CredentialSource\FileSource;
use RexFeed\Vendor\Google\Auth\CredentialSource\UrlSource;
use RexFeed\Vendor\Google\Auth\ExecutableHandler\ExecutableHandler;
use RexFeed\Vendor\Google\Auth\ExternalAccountCredentialSourceInterface;
use RexFeed\Vendor\Google\Auth\FetchAuthTokenInterface;
use RexFeed\Vendor\Google\Auth\GetQuotaProjectInterface;
use RexFeed\Vendor\Google\Auth\GetUniverseDomainInterface;
use RexFeed\Vendor\Google\Auth\HttpHandler\HttpClientCache;
use RexFeed\Vendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use RexFeed\Vendor\Google\Auth\OAuth2;
use RexFeed\Vendor\Google\Auth\ProjectIdProviderInterface;
use RexFeed\Vendor\Google\Auth\UpdateMetadataInterface;
use RexFeed\Vendor\Google\Auth\UpdateMetadataTrait;
use RexFeed\Vendor\GuzzleHttp\Psr7\Request;
