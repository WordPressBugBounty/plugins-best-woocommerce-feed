...
{
    if ($status->code !== \RexFeed\Vendor\Grpc\STATUS_OK) {
...
function sessionManagement($client, &$metrics){
	...
	$createSessionRequest = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\CreateSessionRequest();
	...
	#Get Session
	$getSessionRequest = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\GetSessionRequest();
	...
	#List session
	$listSessionsRequest = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\ListSessionsRequest();
	...
	#Delete session
	$deleteSessionRequest = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\DeleteSessionRequest();
...
function executeSql($client, &$metrics){
	...
	$time_start = microtime_float();
	$executeSqlRequest = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\ExecuteSqlRequest();
...
function read($client, &$metrics){
	...
	# Probing Read call
	$time_start = microtime_float();
	$readRequest = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\ReadRequest();
	$readRequest->setSession($session->getName());
	$readRequest->setTable('users');
	$readRequest->setColumns(['username', 'firstname', 'lastname']);
	$keyset = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\KeySet();
	$keyset->setAll(True);
...
function transaction($client, &$metrics){
	...
	$txn_options = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\TransactionOptions();
	$rw = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\TransactionOptions\ReadWrite();
	$txn_options->setReadWrite($rw);
	$txn_request = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\BeginTransactionRequest();
	...
	# Probing Commit Call
	$commit_request = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\CommitRequest();
	...
	list($txn, $status) = $client->BeginTransaction($txn_request)->wait();
	$rollback_request = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\RollbackRequest();
...
function partition($client, &$metrics){
	...
	$txn_options = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\TransactionOptions();
	$ro = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\TransactionOptions\PBReadOnly();
	$txn_options->setReadOnly($ro);
	$txn_selector = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\TransactionSelector();
	$txn_selector->setBegin($txn_options);

	#Probing PartitionQuery call
	$ptn_query_request = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\PartitionQueryRequest();
	...
	$ptn_read_request = new \RexFeed\Vendor\Google\Cloud\Spanner\V1\PartitionReadRequest();
