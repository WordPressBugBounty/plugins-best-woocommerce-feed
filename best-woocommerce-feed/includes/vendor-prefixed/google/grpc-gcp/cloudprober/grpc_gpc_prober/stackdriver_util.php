...
use RexFeed\Vendor\Google\Cloud\ErrorReporting\V1beta1\ReportErrorsServiceClient;
use RexFeed\Vendor\Google\Cloud\ErrorReporting\V1beta1\ErrorContext;
use RexFeed\Vendor\Google\Cloud\ErrorReporting\V1beta1\ReportedErrorEvent;
use RexFeed\Vendor\Google\Cloud\ErrorReporting\V1beta1\SourceLocation;
