...
use RexFeed\Vendor\Google\Cloud\Firestore\V1beta1\FirestoreGrpcClient;
use RexFeed\Vendor\Google\Cloud\Spanner\V1\SpannerGrpcClient;
...
function executeProbes($api){
	...
	$auth = \RexFeed\Vendor\Google\Auth\ApplicationDefaultCredentials::getCredentials($_OAUTH_SCOPE);
	$opts = [
  		'credentials' => \RexFeed\Vendor\Grpc\ChannelCredentials::createSsl(),
