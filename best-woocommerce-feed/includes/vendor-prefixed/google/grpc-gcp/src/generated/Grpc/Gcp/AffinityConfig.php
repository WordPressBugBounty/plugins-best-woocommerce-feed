 ...
 */
class AffinityConfig extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Grpc\Gcp\AffinityConfig_Command::class);
        $this->command = $var;
