...
class Config
{
     ...
     * @param \RexFeed\Vendor\Grpc\Gcp\ApiConfig   $conf
    ...
    public function __construct($target, $conf = null, ?CacheItemPoolInterface $cacheItemPool = null)
    {
        if ($conf == null) {
            ...
            $this->gcp_call_invoker = new \RexFeed\Vendor\Grpc\DefaultCallInvoker();
            return;
        }
    ...
    /**
     * @return \RexFeed\Vendor\Grpc\CallInvoker The call invoker to be hooked into the gRPC
     */
