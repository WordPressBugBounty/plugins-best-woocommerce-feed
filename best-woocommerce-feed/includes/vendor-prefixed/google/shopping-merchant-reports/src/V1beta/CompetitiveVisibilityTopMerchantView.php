 ...
 */
class CompetitiveVisibilityTopMerchantView extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     * Date of this row.
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1beta\TrafficSource\TrafficSourceEnum::class);
