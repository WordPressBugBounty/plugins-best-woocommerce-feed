...
class ProductView extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
     ...
     *           Aggregated status.
     *     @type \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1beta\ProductView\ItemIssue[] $item_issues
     *           List of item issues for the product.
     *           **This field cannot be used for sorting the results.**
     *           **Only selected attributes of this field (for example,
     *           `item_issues.severity.aggregated_severity`) can be used for filtering the
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1beta\ProductView\AggregatedReportingContextStatus::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.reports.v1beta.ProductView.ItemIssue item_issues = 27;</code>
     * @return RepeatedField<\RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1beta\ProductView\ItemIssue>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.reports.v1beta.ProductView.ItemIssue item_issues = 27;</code>
     * @param \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1beta\ProductView\ItemIssue[] $var
     * @return $this
     */
    public function setItemIssues($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1beta\ProductView\ItemIssue::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1beta\ProductView\ClickPotential::class);
