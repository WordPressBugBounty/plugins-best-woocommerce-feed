 ...
 */
class BestSellersProductClusterView extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     *     @type \RexFeed\Vendor\Google\Type\Date $report_date
     *           Report date. The value of this field can only be one of the following:
     *           *   The first day of the week (Monday) for weekly reports,
     *           *   The first day of the month for monthly reports.
     *           Required in the `SELECT` clause. If a `WHERE` condition on `report_date` is
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1beta\ReportGranularity\ReportGranularityEnum::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1beta\BestSellersProductClusterView\InventoryStatus::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1beta\RelativeDemand\RelativeDemandEnum::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1beta\RelativeDemandChangeType\RelativeDemandChangeTypeEnum::class);
