 ...
 */
class PriceInsightsProductView extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           Current price of the product.
     *     @type \RexFeed\Vendor\Google\Shopping\Type\Price $suggested_price
     *           Latest suggested price for the product.
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1beta\PriceInsightsProductView\Effectiveness::class);
