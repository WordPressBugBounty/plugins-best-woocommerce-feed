...
class BestSellersProductClusterView extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\ReportGranularity\ReportGranularityEnum::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\BestSellersProductClusterView\InventoryStatus::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\RelativeDemand\RelativeDemandEnum::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\RelativeDemandChangeType\RelativeDemandChangeTypeEnum::class);
