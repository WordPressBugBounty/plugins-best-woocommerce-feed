 ...
 */
class ProductPerformanceView extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           Marketing method to which metrics apply. Segment.
     *     @type \RexFeed\Vendor\Google\Type\Date $date
     *           Date in the merchant timezone to which metrics apply. Segment.
     *           Condition on `date` is required in the `WHERE` clause.
     *     @type \RexFeed\Vendor\Google\Type\Date $week
     *           First day of the week (Monday) of the metrics date in the merchant
     *           timezone. Segment.
     ...
     *           metric is a sum of all such credits. Metric.
     *           Available only for the `FREE` traffic source.
     *     @type \RexFeed\Vendor\Google\Shopping\Type\Price $conversion_value
     *           Value of conversions attributed to the product, reported on the conversion
     *           date. Metric.
     *           Available only for the `FREE` traffic source.
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\MarketingMethod\MarketingMethodEnum::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\StoreType\StoreTypeEnum::class);
        $this->store_type = $var;
