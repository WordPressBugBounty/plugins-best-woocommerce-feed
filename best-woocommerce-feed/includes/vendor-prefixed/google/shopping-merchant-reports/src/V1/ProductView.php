 ...
 */
class ProductView extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           Product type (5th level) in merchant's own [product
     *           taxonomy](https://support.google.com/merchants/answer/6324406).
     *     @type \RexFeed\Vendor\Google\Shopping\Type\Price $price
     *           Product price. Absent if the information about the price of the product is
     *           not available.
     ...
     *           Link to the processed image of the product, hosted on the Google
     *           infrastructure.
     *     @type \RexFeed\Vendor\Google\Protobuf\Timestamp $creation_time
     *           The time the merchant created the product in timestamp seconds.
     *     @type \RexFeed\Vendor\Google\Type\Date $expiration_date
     *           Expiration date for the product, specified on insertion.
     *     @type int $aggregated_reporting_context_status
     *           Aggregated status across all reporting contexts.
     *           Reporting contexts included in the computation of the aggregated status can
     *           be restricted using a filter on the `reporting_context` field.
     *     @type \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\ProductView\StatusPerReportingContext[] $status_per_reporting_context
     *           Detailed product status per reporting context.
     *           Reporting contexts included in this list can be restricted using a filter
     *           on the `reporting_context` field.
     *           Equivalent to
     ...
     *           **This field can only be used in the `WHERE` clause and cannot be selected
     *           in the `SELECT` clause.**
     *     @type \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\ProductView\ItemIssue[] $item_issues
     *           List of item issues for the product.
     *           **This field cannot be used for sorting the results.**
     *           **Only selected attributes of this field (for example,
     *           `item_issues.severity.aggregated_severity`) can be used for filtering the
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Type\Channel\ChannelEnum::class);
        $this->channel = $var;
     ...
     *
     * Generated from protobuf field <code>.google.shopping.type.Price price = 17;</code>
     * @return \RexFeed\Vendor\Google\Shopping\Type\Price|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.shopping.type.Price price = 17;</code>
     * @param \RexFeed\Vendor\Google\Shopping\Type\Price $var
     * @return $this
     */
    public function setPrice($var)
    {
        GPBUtil::checkMessage($var, \RexFeed\Vendor\Google\Shopping\Type\Price::class);
        $this->price = $var;
     ...
     *
     * Generated from protobuf field <code>.google.type.Date expiration_date = 25;</code>
     * @return \RexFeed\Vendor\Google\Type\Date|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.type.Date expiration_date = 25;</code>
     * @param \RexFeed\Vendor\Google\Type\Date $var
     * @return $this
     */
    public function setExpirationDate($var)
    {
        GPBUtil::checkMessage($var, \RexFeed\Vendor\Google\Type\Date::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\ProductView\AggregatedReportingContextStatus::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.reports.v1.ProductView.StatusPerReportingContext status_per_reporting_context = 32;</code>
     * @return RepeatedField<\RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\ProductView\StatusPerReportingContext>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.reports.v1.ProductView.StatusPerReportingContext status_per_reporting_context = 32;</code>
     * @param \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\ProductView\StatusPerReportingContext[] $var
     * @return $this
     */
    public function setStatusPerReportingContext($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\ProductView\StatusPerReportingContext::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Type\ReportingContext\ReportingContextEnum::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.reports.v1.ProductView.ItemIssue item_issues = 27;</code>
     * @return RepeatedField<\RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\ProductView\ItemIssue>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.reports.v1.ProductView.ItemIssue item_issues = 27;</code>
     * @param \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\ProductView\ItemIssue[] $var
     * @return $this
     */
    public function setItemIssues($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\ProductView\ItemIssue::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Shopping\Merchant\Reports\V1\ProductView\ClickPotential::class);
