...
namespace RexFeed\Vendor\Google\Cloud\Logging\Type;
 ...
 */
class HttpRequest extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           [HTTP/1.1 Header Field
     *           Definitions](https://datatracker.ietf.org/doc/html/rfc2616#section-14.36).
     *     @type \RexFeed\Vendor\Google\Protobuf\Duration $latency
     *           The request processing latency on the server, from the time the request was
     *           received until the response was sent.
    ...
    public function __construct($data = NULL) {
        \RexFeed\Vendor\GPBMetadata\Google\Logging\Type\HttpRequest::initOnce();
