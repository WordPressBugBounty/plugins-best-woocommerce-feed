 ...
 */
class ResourcePolicyMember extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    public function __construct($data = NULL) {
        \RexFeed\Vendor\GPBMetadata\Google\Iam\V1\ResourcePolicyMember::initOnce();
