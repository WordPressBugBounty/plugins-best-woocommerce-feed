 ...
 */
class AuditConfigDelta extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Cloud\Iam\V1\AuditConfigDelta\Action::class);
        $this->action = $var;
