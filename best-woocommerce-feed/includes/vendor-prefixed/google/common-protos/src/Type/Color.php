 ...
 */
class Color extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *     @type float $blue
     *           The amount of blue in the color as a value in the interval [0, 1].
     *     @type \RexFeed\Vendor\Google\Protobuf\FloatValue $alpha
     *           The fraction of this color that should be applied to the pixel. That is,
     *           the final pixel color is defined by the equation:
     *             `pixel color = alpha * (this color) + (1.0 - alpha) * (background color)`
     *           This means that a value of 1.0 corresponds to a solid color, whereas
    ...
    public function __construct($data = NULL) {
        \RexFeed\Vendor\GPBMetadata\Google\Type\Color::initOnce();
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.FloatValue alpha = 4;</code>
     * @return \RexFeed\Vendor\Google\Protobuf\FloatValue|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.FloatValue alpha = 4;</code>
     * @param \RexFeed\Vendor\Google\Protobuf\FloatValue $var
     * @return $this
     */
    public function setAlpha($var)
    {
        GPBUtil::checkMessage($var, \RexFeed\Vendor\Google\Protobuf\FloatValue::class);
        $this->alpha = $var;
    ...
    /**
     * Sets the field by wrapping a primitive type in a RexFeed\Vendor\Google\Protobuf\FloatValue object.
