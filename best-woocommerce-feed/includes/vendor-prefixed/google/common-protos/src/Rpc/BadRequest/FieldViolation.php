...
namespace RexFeed\Vendor\Google\Rpc\BadRequest;
 ...
 */
class FieldViolation extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           characters and match a regular expression of `[A-Z][A-Z0-9_]+[A-Z0-9]`,
     *           which represents UPPER_SNAKE_CASE.
     *     @type \RexFeed\Vendor\Google\Rpc\LocalizedMessage $localized_message
     *           Provides a localized error message for field-level errors that is safe to
     *           return to the API consumer.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.rpc.LocalizedMessage localized_message = 4;</code>
     * @return \RexFeed\Vendor\Google\Rpc\LocalizedMessage|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.rpc.LocalizedMessage localized_message = 4;</code>
     * @param \RexFeed\Vendor\Google\Rpc\LocalizedMessage $var
     * @return $this
     */
    public function setLocalizedMessage($var)
    {
        GPBUtil::checkMessage($var, \RexFeed\Vendor\Google\Rpc\LocalizedMessage::class);
