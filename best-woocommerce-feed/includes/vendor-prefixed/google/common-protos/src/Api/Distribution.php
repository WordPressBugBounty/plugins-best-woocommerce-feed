 ...
 */
class Distribution extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           describes Welford's method for accumulating this sum in one pass.
     *           If `count` is zero then this field must be zero.
     *     @type \RexFeed\Vendor\Google\Api\Distribution\Range $range
     *           If specified, contains the range of the population values. The field
     *           must not be present if the `count` is zero.
     *     @type \RexFeed\Vendor\Google\Api\Distribution\BucketOptions $bucket_options
     *           Defines the histogram bucket boundaries. If the distribution does not
     *           contain a histogram, then omit this field.
     ...
     *           counts for the finite buckets (number 1 through N-2). The N'th value in
     *           `bucket_counts` is the count for the overflow bucket (number N-1).
     *     @type \RexFeed\Vendor\Google\Api\Distribution\Exemplar[] $exemplars
     *           Must be in increasing order of `value` field.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.Distribution.Range range = 4;</code>
     * @return \RexFeed\Vendor\Google\Api\Distribution\Range|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.Distribution.Range range = 4;</code>
     * @param \RexFeed\Vendor\Google\Api\Distribution\Range $var
     * @return $this
     */
    public function setRange($var)
    {
        GPBUtil::checkMessage($var, \RexFeed\Vendor\Google\Api\Distribution\Range::class);
        $this->range = $var;
     ...
     *
     * Generated from protobuf field <code>.google.api.Distribution.BucketOptions bucket_options = 6;</code>
     * @return \RexFeed\Vendor\Google\Api\Distribution\BucketOptions|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.Distribution.BucketOptions bucket_options = 6;</code>
     * @param \RexFeed\Vendor\Google\Api\Distribution\BucketOptions $var
     * @return $this
     */
    public function setBucketOptions($var)
    {
        GPBUtil::checkMessage($var, \RexFeed\Vendor\Google\Api\Distribution\BucketOptions::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::INT64);
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.Distribution.Exemplar exemplars = 10;</code>
     * @return RepeatedField<\RexFeed\Vendor\Google\Api\Distribution\Exemplar>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.Distribution.Exemplar exemplars = 10;</code>
     * @param \RexFeed\Vendor\Google\Api\Distribution\Exemplar[] $var
     * @return $this
     */
    public function setExemplars($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \RexFeed\Vendor\Google\Api\Distribution\Exemplar::class);
        $this->exemplars = $arr;
