 ...
 */
class RoutingRule extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     *     @type \RexFeed\Vendor\Google\Api\RoutingParameter[] $routing_parameters
     *           A collection of Routing Parameter specifications.
     *           **NOTE:** If multiple Routing Parameters describe the same key
     *           (via the `path_template` field or via the `field` field when
     *           `path_template` is not provided), "last one wins" rule
    ...
    public function __construct($data = NULL) {
        \RexFeed\Vendor\GPBMetadata\Google\Api\Routing::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.RoutingParameter routing_parameters = 2;</code>
     * @return RepeatedField<\RexFeed\Vendor\Google\Api\RoutingParameter>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.RoutingParameter routing_parameters = 2;</code>
     * @param \RexFeed\Vendor\Google\Api\RoutingParameter[] $var
     * @return $this
     */
    public function setRoutingParameters($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \RexFeed\Vendor\Google\Api\RoutingParameter::class);
