 ...
 */
class CommonLanguageSettings extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           The destination where API teams want this client library to be published.
     *     @type \RexFeed\Vendor\Google\Api\SelectiveGapicGeneration $selective_gapic_generation
     *           Configuration for which RPCs should be generated in the GAPIC client.
     *           Note: This field should not be used in most cases.
     * }
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::ENUM, \RexFeed\Vendor\Google\Api\ClientLibraryDestination::class);
     ...
     *
     * Generated from protobuf field <code>.google.api.SelectiveGapicGeneration selective_gapic_generation = 3;</code>
     * @return \RexFeed\Vendor\Google\Api\SelectiveGapicGeneration|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.SelectiveGapicGeneration selective_gapic_generation = 3;</code>
     * @param \RexFeed\Vendor\Google\Api\SelectiveGapicGeneration $var
     * @return $this
     */
    public function setSelectiveGapicGeneration($var)
    {
        GPBUtil::checkMessage($var, \RexFeed\Vendor\Google\Api\SelectiveGapicGeneration::class);
