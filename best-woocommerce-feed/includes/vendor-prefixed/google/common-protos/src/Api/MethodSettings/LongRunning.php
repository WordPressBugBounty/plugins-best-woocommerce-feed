...
namespace RexFeed\Vendor\Google\Api\MethodSettings;
 ...
 */
class LongRunning extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     *     @type \RexFeed\Vendor\Google\Protobuf\Duration $initial_poll_delay
     *           Initial delay after which the first poll request will be made.
     *           Default value: 5 seconds.
     ...
     *           reaches max_poll_delay.
     *           Default value: 1.5.
     *     @type \RexFeed\Vendor\Google\Protobuf\Duration $max_poll_delay
     *           Maximum time between two subsequent poll requests.
     *           Default value: 45 seconds.
     *     @type \RexFeed\Vendor\Google\Protobuf\Duration $total_poll_timeout
     *           Total polling timeout.
     *           Default value: 5 minutes.
     * }
     */
