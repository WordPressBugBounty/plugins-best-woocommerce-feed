 ...
 */
class HttpRule extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *     @type \RexFeed\Vendor\Google\Api\CustomHttpPattern $custom
     ...
     *           NOTE: The referred field must be present at the top-level of the response
     *           message type.
     *     @type \RexFeed\Vendor\Google\Api\HttpRule[] $additional_bindings
     *           Additional HTTP bindings for the selector. Nested bindings must
     *           not contain an `additional_bindings` field themselves (that is,
     *           the nesting may only be one level deep).
     * }
     ...
     * @return \RexFeed\Vendor\Google\Api\CustomHttpPattern|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.CustomHttpPattern custom = 8;</code>
     * @param \RexFeed\Vendor\Google\Api\CustomHttpPattern $var
     * @return $this
     */
    public function setCustom($var)
    {
        GPBUtil::checkMessage($var, \RexFeed\Vendor\Google\Api\CustomHttpPattern::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.HttpRule additional_bindings = 11;</code>
     * @return RepeatedField<\RexFeed\Vendor\Google\Api\HttpRule>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.HttpRule additional_bindings = 11;</code>
     * @param \RexFeed\Vendor\Google\Api\HttpRule[] $var
     * @return $this
     */
    public function setAdditionalBindings($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \RexFeed\Vendor\Google\Api\HttpRule::class);
