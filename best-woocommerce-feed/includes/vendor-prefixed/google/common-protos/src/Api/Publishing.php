 ...
 */
class Publishing extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     *     @type \RexFeed\Vendor\Google\Api\MethodSettings[] $method_settings
     *           A list of API method settings, e.g. the behavior for methods that use the
     *           long-running operation pattern.
     ...
     *           For whom the client library is being published.
     *     @type \RexFeed\Vendor\Google\Api\ClientLibrarySettings[] $library_settings
     *           Client library settings.  If the same version string appears multiple
     *           times in this list, then the last one wins.  Settings from earlier
     *           settings with the same version string are discarded.
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.MethodSettings method_settings = 2;</code>
     * @return RepeatedField<\RexFeed\Vendor\Google\Api\MethodSettings>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.MethodSettings method_settings = 2;</code>
     * @param \RexFeed\Vendor\Google\Api\MethodSettings[] $var
     * @return $this
     */
    public function setMethodSettings($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \RexFeed\Vendor\Google\Api\MethodSettings::class);
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Api\ClientLibraryOrganization::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.ClientLibrarySettings library_settings = 109;</code>
     * @return RepeatedField<\RexFeed\Vendor\Google\Api\ClientLibrarySettings>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.ClientLibrarySettings library_settings = 109;</code>
     * @param \RexFeed\Vendor\Google\Api\ClientLibrarySettings[] $var
     * @return $this
     */
    public function setLibrarySettings($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \RexFeed\Vendor\Google\Api\ClientLibrarySettings::class);
