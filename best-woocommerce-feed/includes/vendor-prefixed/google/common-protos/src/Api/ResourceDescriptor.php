 ...
 */
class ResourceDescriptor extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Api\ResourceDescriptor\History::class);
        $this->history = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::ENUM, \RexFeed\Vendor\Google\Api\ResourceDescriptor\Style::class);
        $this->style = $arr;
