 ...
 */
class AuthProvider extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           Redirect URL if JWT token is required but not present or is expired.
     *           Implement authorizationUrl of securityDefinitions in OpenAPI spec.
     *     @type \RexFeed\Vendor\Google\Api\JwtLocation[] $jwt_locations
     *           Defines the locations to extract the JWT.  For now it is only used by the
     *           Cloud Endpoints to store the OpenAPI extension [x-google-jwt-locations]
     *           (https://cloud.google.com/endpoints/docs/openapi/openapi-extensions#x-google-jwt-locations)
     *           JWT locations can be one of HTTP headers, URL query parameters or
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.JwtLocation jwt_locations = 6;</code>
     * @return RepeatedField<\RexFeed\Vendor\Google\Api\JwtLocation>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.JwtLocation jwt_locations = 6;</code>
     * @param \RexFeed\Vendor\Google\Api\JwtLocation[] $var
     * @return $this
     */
    public function setJwtLocations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \RexFeed\Vendor\Google\Api\JwtLocation::class);
