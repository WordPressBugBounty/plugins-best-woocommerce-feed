 ...
 */
class BackendRule extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *           https://www.iana.org/assignments/tls-extensiontype-values/tls-extensiontype-values.xhtml#alpn-protocol-ids
     *           for more details on the supported values.
     *     @type array|\RexFeed\Vendor\Google\Protobuf\Internal\MapField $overrides_by_request_protocol
     *           The map between request protocol and the backend address.
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Api\BackendRule\PathTranslation::class);
    ...
    {
        $arr = GPBUtil::checkMapField($var, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::STRING, \RexFeed\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \RexFeed\Vendor\Google\Api\BackendRule::class);
