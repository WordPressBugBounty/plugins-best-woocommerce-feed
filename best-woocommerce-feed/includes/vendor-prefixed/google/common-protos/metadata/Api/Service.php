...
class Service
{
    ...
    public static function initOnce() {
        ...
        \RexFeed\Vendor\GPBMetadata\Google\Api\Auth::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Backend::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Billing::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Client::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Context::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Control::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Documentation::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Endpoint::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Http::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Log::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Logging::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Metric::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\MonitoredResource::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Monitoring::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Quota::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\SourceInfo::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\SystemParameter::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Api\Usage::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Protobuf\Api::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Protobuf\Type::initOnce();
        \RexFeed\Vendor\GPBMetadata\Google\Protobuf\Wrappers::initOnce();
