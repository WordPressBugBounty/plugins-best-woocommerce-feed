...
/**
 * Base class for RexFeed\Vendor\Google\Protobuf\Any, this contains hand-written convenience
 * methods like pack() and unpack().
 */
class AnyBase extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
