 ...
 */
class Field extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
     * The field type.
     *
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Protobuf\Field\Kind::class);
        $this->kind = $var;
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Protobuf\Field\Cardinality::class);
