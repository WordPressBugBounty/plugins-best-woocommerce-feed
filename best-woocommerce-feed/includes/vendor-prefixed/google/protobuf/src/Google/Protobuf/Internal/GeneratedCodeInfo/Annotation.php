...
namespace RexFeed\Vendor\Google\Protobuf\Internal\GeneratedCodeInfo;
 ...
 */
class Annotation extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Protobuf\Internal\GeneratedCodeInfo\Annotation\Semantic::class);
        $this->semantic = $var;
