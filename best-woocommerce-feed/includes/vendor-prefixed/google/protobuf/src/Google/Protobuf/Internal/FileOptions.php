 ...
 */
class FileOptions extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \RexFeed\Vendor\Google\Protobuf\Internal\FileOptions\OptimizeMode::class);
