...
/**
 * Base class for RexFeed\Vendor\Google\Protobuf\Timestamp, this contains hand-written
 * convenience methods.
 */
class TimestampBase extends \RexFeed\Vendor\Google\Protobuf\Internal\Message
{
    /*
