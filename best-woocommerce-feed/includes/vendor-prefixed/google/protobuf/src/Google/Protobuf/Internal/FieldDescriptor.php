...
class FieldDescriptor
{
    ...
    {
        $this->public_desc = new \RexFeed\Vendor\Google\Protobuf\FieldDescriptor($this);
    }
    ...
    {
        return $this->getType() == GPBType::MESSAGE &&
            $this->getMessageType()->getClass() === "RexFeed\Vendor\Google\Protobuf\Timestamp";
    }
    ...
    public function isWrapperType()
    {
        if ($this->getType() == GPBType::MESSAGE) {
            ...
            return in_array($class, [
                "RexFeed\Vendor\Google\Protobuf\DoubleValue",
                "RexFeed\Vendor\Google\Protobuf\FloatValue",
                "RexFeed\Vendor\Google\Protobuf\Int64Value",
                "RexFeed\Vendor\Google\Protobuf\UInt64Value",
                "RexFeed\Vendor\Google\Protobuf\Int32Value",
                "RexFeed\Vendor\Google\Protobuf\UInt32Value",
                "RexFeed\Vendor\Google\Protobuf\BoolValue",
                "RexFeed\Vendor\Google\Protobuf\StringValue",
                "RexFeed\Vendor\Google\Protobuf\BytesValue",
            ]);
        }
        return false;
    }
