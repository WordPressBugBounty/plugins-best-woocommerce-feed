...
use RexFeed\Vendor\Google\Protobuf\Internal\CodedInputStream;
use RexFeed\Vendor\Google\Protobuf\Internal\CodedOutputStream;
use RexFeed\Vendor\Google\Protobuf\Internal\DescriptorPool;
use RexFeed\Vendor\Google\Protobuf\Internal\GPBType;
use RexFeed\Vendor\Google\Protobuf\Internal\GPBWire;
use RexFeed\Vendor\Google\Protobuf\Internal\MapEntry;
use RexFeed\Vendor\Google\Protobuf\ListValue;
use RexFeed\Vendor\Google\Protobuf\RepeatedField;
use RexFeed\Vendor\Google\Protobuf\PrintOptions;
use RexFeed\Vendor\Google\Protobuf\Value;
use RexFeed\Vendor\Google\Protobuf\Struct;
use RexFeed\Vendor\Google\Protobuf\NullValue;
...
class Message
{
        ...
        $is_map_key = false)
    {
        switch ($field->getType()) {
            case GPBType::MESSAGE:
                ...
                if (is_a($submsg, "RexFeed\Vendor\Google\Protobuf\Duration")) {
                    if (is_null($value)) {
                        return $this->defaultValue($field);
                ...
                } else if (is_a($submsg, "RexFeed\Vendor\Google\Protobuf\FieldMask")) {
                    if (is_null($value)) {
                        return $this->defaultValue($field);
                    }
                    try {
                    ...
                    if (is_null($value) &&
                        !is_a($submsg, "RexFeed\Vendor\Google\Protobuf\Value")) {
                        return $this->defaultValue($field);
                    }
    ...
    {
        if (is_a($this, "RexFeed\Vendor\Google\Protobuf\Any")) {
            $this->clear();
        ...
        if (is_a($this, "RexFeed\Vendor\Google\Protobuf\DoubleValue") ||
            is_a($this, "RexFeed\Vendor\Google\Protobuf\FloatValue")  ||
            is_a($this, "RexFeed\Vendor\Google\Protobuf\Int64Value")  ||
            is_a($this, "RexFeed\Vendor\Google\Protobuf\UInt64Value") ||
            is_a($this, "RexFeed\Vendor\Google\Protobuf\Int32Value")  ||
            is_a($this, "RexFeed\Vendor\Google\Protobuf\UInt32Value") ||
            is_a($this, "RexFeed\Vendor\Google\Protobuf\BoolValue")   ||
            is_a($this, "RexFeed\Vendor\Google\Protobuf\StringValue")) {
            $this->setValue($array);
            return;
        }
        if (is_a($this, "RexFeed\Vendor\Google\Protobuf\BytesValue")) {
            $this->setValue(base64_decode($array));
            return;
        }
        if (is_a($this, "RexFeed\Vendor\Google\Protobuf\Duration")) {
            $this->mergeFrom(GPBUtil::parseDuration($array));
            return;
        }
        if (is_a($this, "RexFeed\Vendor\Google\Protobuf\FieldMask")) {
            $this->mergeFrom(GPBUtil::parseFieldMask($array));
            return;
        }
        if (is_a($this, "RexFeed\Vendor\Google\Protobuf\Timestamp")) {
            $this->mergeFrom(GPBUtil::parseTimestamp($array));
            return;
        }
        if (is_a($this, "RexFeed\Vendor\Google\Protobuf\Struct")) {
        ...
        if (is_a($this, "RexFeed\Vendor\Google\Protobuf\Value")) {
            if (is_bool($array)) {
    ...
    public function parseFromJsonStream($input, $ignore_unknown)
    {
        ...
        if ($this instanceof \RexFeed\Vendor\Google\Protobuf\ListValue) {
            $array = ["values"=>$array];
        }
        if (is_null($array)) {
            if ($this instanceof \RexFeed\Vendor\Google\Protobuf\Value) {
              $this->setNullValue(\RexFeed\Vendor\Google\Protobuf\NullValue::NULL_VALUE);
              return;
            } else {
              throw new GPBDecodeException(
    ...
    public function serializeToJsonStream(&$output)
    {
        ...
        } elseif (get_class($this) === 'RexFeed\Vendor\Google\Protobuf\Struct') {
            $field = $this->desc->getField()[1];
            if (!$this->existField($field)) {
                $output->writeRaw("{}", 2);
            } else {
    ...
    private function fieldDataOnlyJsonByteSize($field, $value, $options = 0)
    {
        ...
        switch ($field->getType()) {
            ...
            case GPBType::ENUM:
                ...
                if ($enum_desc->getClass() === "RexFeed\Vendor\Google\Protobuf\NullValue") {
                    $size += 4;
                    break;
                }
...
#                 break;
    ...
    public function jsonByteSize($options = 0)
    {
        ...
        } elseif (get_class($this) === 'RexFeed\Vendor\Google\Protobuf\FieldMask') {
            $field_mask = GPBUtil::formatFieldMask($this);
            $size += strlen($field_mask) + 2;  // 2 for ""
        } elseif (get_class($this) === 'RexFeed\Vendor\Google\Protobuf\Duration') {
            $duration = GPBUtil::formatDuration($this) . "s";
    ...
    public function __debugInfo()
    {
        ...
        if (is_a($this, 'RexFeed\Vendor\Google\Protobuf\BoolValue')
            || is_a($this, 'RexFeed\Vendor\Google\Protobuf\BytesValue')
            || is_a($this, 'RexFeed\Vendor\Google\Protobuf\DoubleValue')
            || is_a($this, 'RexFeed\Vendor\Google\Protobuf\FloatValue')
            || is_a($this, 'RexFeed\Vendor\Google\Protobuf\StringValue')
            || is_a($this, 'RexFeed\Vendor\Google\Protobuf\Int32Value')
            || is_a($this, 'RexFeed\Vendor\Google\Protobuf\Int64Value')
        ...
        if (
            is_a($this, 'RexFeed\Vendor\Google\Protobuf\Duration')
            || is_a($this, 'RexFeed\Vendor\Google\Protobuf\Timestamp')
        ) {
            return [
