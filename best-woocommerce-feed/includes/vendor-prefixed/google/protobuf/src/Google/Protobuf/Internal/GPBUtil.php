...
use RexFeed\Vendor\Google\Protobuf\Duration;
use RexFeed\Vendor\Google\Protobuf\FieldMask;
use RexFeed\Vendor\Google\Protobuf\Internal\GPBType;
use RexFeed\Vendor\Google\Protobuf\Internal\MapField;
...
class GPBUtil
{
        ...
        &$previous_classname)
    {
        ...
        $ns_prefix = '';
        if (__NAMESPACE__ !== 'Google\Protobuf\Internal') {
            $ns_prefix = substr(__NAMESPACE__, 0, -strlen('Google\Protobuf\Internal'));
        }
        ...
        if (!is_null($option) && $option->hasPhpNamespace()) {
            ...
            if ($namespace !== "") {
                $classname = $ns_prefix . $namespace . "\\" . $class_name_without_package;
                $legacy_classname =
                    $ns_prefix . $namespace . "\\" . $legacy_class_name_without_package;
                $previous_classname =
                    $ns_prefix . $namespace . "\\" . $previous_class_name_without_package;
                return;
            } else {
                $classname = $ns_prefix . $class_name_without_package;
                $legacy_classname = $ns_prefix . $legacy_class_name_without_package;
                $previous_classname = $ns_prefix . $previous_class_name_without_package;
                return;
            }
        }
    ...
    public static function parseTimestamp($timestamp)
    {
        ...
        $value = new \RexFeed\Vendor\Google\Protobuf\Timestamp();
    ...
    {
        return is_a($msg, 'RexFeed\Vendor\Google\Protobuf\Any')         ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\ListValue")   ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\Struct")      ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\Value")       ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\Duration")    ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\Timestamp")   ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\FieldMask")   ||
               static::hasJsonValue($msg);
    }

    public static function hasJsonValue($msg)
    {
        return is_a($msg, "RexFeed\Vendor\Google\Protobuf\DoubleValue") ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\FloatValue")  ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\Int64Value")  ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\UInt64Value") ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\Int32Value")  ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\UInt32Value") ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\BoolValue")   ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\StringValue") ||
               is_a($msg, "RexFeed\Vendor\Google\Protobuf\BytesValue");
    }
}
