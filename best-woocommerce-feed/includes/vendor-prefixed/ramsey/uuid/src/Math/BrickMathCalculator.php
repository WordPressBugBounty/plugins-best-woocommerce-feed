...
namespace RexFeed\Vendor\Ramsey\Uuid\Math;

use RexFeed\Vendor\Brick\Math\BigDecimal;
use RexFeed\Vendor\Brick\Math\BigInteger;
use RexFeed\Vendor\Brick\Math\Exception\MathException;
use RexFeed\Vendor\Ramsey\Uuid\Exception\InvalidArgumentException;
use RexFeed\Vendor\Ramsey\Uuid\Type\Decimal;
use RexFeed\Vendor\Ramsey\Uuid\Type\Hexadecimal;
use RexFeed\Vendor\Ramsey\Uuid\Type\Integer as IntegerObject;
use RexFeed\Vendor\Ramsey\Uuid\Type\NumberInterface;
