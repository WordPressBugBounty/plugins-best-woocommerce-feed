...
use RexFeed\Vendor\GuzzleHttp\Handler\CurlHandler;
use RexFeed\Vendor\GuzzleHttp\Handler\CurlMultiHandler;
use RexFeed\Vendor\GuzzleHttp\Handler\CurlShareHandleState;
use RexFeed\Vendor\GuzzleHttp\Handler\CurlVersion;
use RexFeed\Vendor\GuzzleHttp\Handler\Proxy;
use RexFeed\Vendor\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    {
        rexfeed_vendor_trigger_deprecation('guzzlehttp/guzzle', '7.1', '%s() is deprecated and will be removed in 8.0. This method is not needed in PHP 5.6+.', __METHOD__);
...
EOT
    ...
    {
        rexfeed_vendor_trigger_deprecation('guzzlehttp/guzzle', '7.15', '%s() is deprecated and will be removed in 8.0. Use PHP\'s json_decode() instead.', __METHOD__);
    ...
    {
        rexfeed_vendor_trigger_deprecation('guzzlehttp/guzzle', '7.15', '%s() is deprecated and will be removed in 8.0. Use PHP\'s json_encode() instead.', __METHOD__);
