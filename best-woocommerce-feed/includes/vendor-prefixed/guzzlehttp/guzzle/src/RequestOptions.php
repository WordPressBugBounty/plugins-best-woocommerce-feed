...
final class RequestOptions
{
    ...
    /**
     * body: (resource|string|null|int|float|bool|\RexFeed\Vendor\Psr\Http\Message\StreamInterface|(callable&object)|\Iterator|\Stringable)
    ...
    /**
     * cookies: (false|RexFeed\Vendor\GuzzleHttp\Cookie\CookieJarInterface, default=false)
    ...
    /**
     * sink: (resource|string|\RexFeed\Vendor\Psr\Http\Message\StreamInterface) Where the data
