...
use RexFeed\Vendor\GuzzleHttp\Psr7\Exception\MalformedUriException;
...
class Uri implements UriInterface, \JsonSerializable
{
     ...
     * `RexFeed\Vendor\Psr\Http\Message\UriInterface::__toString`.
     *
     ...
     *
     * `RexFeed\Vendor\Psr\Http\Message\UriInterface::getPort` may return null or the standard port. This method can be used
