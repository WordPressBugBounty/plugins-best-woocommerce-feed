...
class AccountStatusProducts extends \RexFeed\Google\Collection
{
...
\class_alias(AccountStatusProducts::class, 'RexFeed\\Google_Service_ShoppingContent_AccountStatusProducts');
