...
namespace RexFeed\GuzzleHttp\Handler;

use RexFeed\GuzzleHttp\Exception\ConnectException;
use RexFeed\GuzzleHttp\Exception\RequestException;
use RexFeed\GuzzleHttp\Promise as P;
use RexFeed\GuzzleHttp\Promise\FulfilledPromise;
use RexFeed\GuzzleHttp\Promise\PromiseInterface;
use RexFeed\GuzzleHttp\Psr7;
use RexFeed\GuzzleHttp\TransferStats;
use RexFeed\GuzzleHttp\Utils;
...
use RexFeed\Psr\Http\Message\UriInterface;
/**
