...
namespace RexFeed\GuzzleHttp\Exception;

use RexFeed\GuzzleHttp\BodySummarizer;
use RexFeed\GuzzleHttp\BodySummarizerInterface;
use RexFeed\Psr\Http\Client\RequestExceptionInterface;
